...
from restoration import MAP_TV
...
if __name__ == "__main__":
    ...
    parser.add_argument('--vae name', type=str, default=0)
    ...
    for subj in subj_list: # Iterate every subject
        ...
        for batch_idx, (scan, seg, mask) in enumerate(subj_loader):
            ...
            restored_batch = MAP_TV(scan, decoded_mu, vae_model, riter, device, weight, step_rate)
