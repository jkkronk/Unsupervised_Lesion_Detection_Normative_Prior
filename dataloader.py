...
class camcan_dataset(Dataset):
    def __init__(self, data_path, train, img_size, data_aug=0):
        ...
        self.aug = data_aug
        path = (data_path + 'camcan_t2_train_set_6.hdf5') if train else (data_path + 'camcan_t2_val_set_6.hdf5')
    ...
    def transform(self, img):
        ...
        if self.aug: # Augmentation only performed on train set
            ...
            seq_all = iaa.Sequential([
                ...
                iaa.ElasticTransformation(alpha=(0.0, 50.0), sigma=5.0),  # Elastic
                iaa.blur.AverageBlur(k=(0, 6)),  # Gausian blur
